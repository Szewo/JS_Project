...
class VendingMachineTests(unittest.TestCase):
    ...
    def test_product_price(self):
        price = self.vending_machine.get_available_products()['30'].get_price()
    ...
    def test_buy_product_without_rest(self):
        ...
        self.assertIn('Reszta: 0.00', self.vending_machine.get_message())

    def test_buy_with_rest(self):
        # Product number 44, price 2.79
        self.vending_machine.get_available_coins().add_coin(Coin('0.01'))
        self.vending_machine.get_available_coins().add_coin(Coin('0.10'))
        self.vending_machine.get_available_coins().add_coin(Coin('0.10'))
        self.vending_machine.get_available_coins().add_coin(Coin('0.20'))
        self.assertEqual(self.vending_machine.get_available_coins().sum_of_coins(), Decimal('0.41'))
        ...
        self.vending_machine.pick_product('4')
        self.assertTrue(self.vending_machine.buy_product())
        self.assertIn('Reszta: 0.21', self.vending_machine.get_message())
        self.assertEqual(self.vending_machine.get_available_coins().sum_of_coins(), Decimal('3.20'))
    ...
    def test_buy_all_products(self):
        ...
        self.assertIn('Brak produktu', self.vending_machine.get_message())

    def test_pick_wrong_product_number(self):
        self.vending_machine.pick_product('1')
        self.assertFalse(self.vending_machine.buy_product())
        self.assertIn('Brak produktu o takim numerze', self.vending_machine.get_message())
    ...
    def test_cancel_transaction(self):
        ...
        self.assertIn("Anulowano transakcje", self.vending_machine.get_message())
    ...
    def test_add_more_money(self):
        ...
        self.assertFalse(self.vending_machine.buy_product())
        self.assertIn('Za mało kredytów', self.vending_machine.get_message())
    ...
    def test_unable_to_give_rest(self):
        ...
        self.vending_machine.pick_product('9')
        self.assertFalse(self.vending_machine.buy_product())
        self.assertIn('Tylko odliczona kwota', self.vending_machine.get_message())
